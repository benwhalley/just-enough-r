...
By making a new grid of data, using `expand.grid()`, at values of interest to us, we can plot the interaction and see that the effect of `wt` is diminished as `hp` increases.
