...
Often you will have multiple data files files - for example, those produced by [experimental software](http://www.psychopy.org). 
...
The `list.files()` function creates a [vector](#vectors) of the names of all the files in the directory. 
