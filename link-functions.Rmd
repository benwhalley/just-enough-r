...
For linear regression the link is simply the [identity function](https://en.wikipedia.org/wiki/Identity_function) — that is, the linear model directly predicts the outcome. However for other types of model different functions are used.
