...
It's a useful trick to learn how to 'poke around' inside R objects using the `$` and `@` operators (if you want the gory details [see this guide](http://adv-r.had.co.nz/OO-essentials.html)).
...
[There was no interaction between location of manufacture and number of cylinders, `r apastats::describe.Anova(mpg.anova, term="am:cyl")`, but there was a main effect of location of manufacture, `r apastats::describe.Anova(mpg.anova, term="am:cyl")`, such that US-made cars had significantly higher fuel consumption than European or Japanese brands (see [Figure X or Table X])]{.apa-example}
...
[There were significant differences in reaction times across the 10 days of the study, `r apastats::describe.lmtaov(anova(sleep.model), term='factor(Days)')` such that reaction latencies tended to increase in duration (see [Figure X]).]{.apa-example}
