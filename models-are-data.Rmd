...
[There were significant differences in reaction times across the 10 days of the study, `r rtchanges` such that reaction latencies tended to increase in duration (see [Figure X]).]{.apa-example}
